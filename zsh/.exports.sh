...
export PATH=/opt/homebrew/bin:$PATH:~/apps/bin:${HOME}/.krew/bin:${HOME}/.local/bin:${HOME}/go/bin:/var/lib/flatpak/exports/bin/:~/apps/flutter/bin:~/apps/android-studio/bin:~/go/bin/:${HOME}/node_modules/.bin:$HOME/.bun/bin
